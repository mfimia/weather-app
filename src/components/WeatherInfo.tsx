  ...
  return (
    <Fragment>
      <div className="flex items-center mb-4">
        <img className="w-16 h-16 mr-4" src={currentWeather.iconUrl} alt={currentWeather.condition} />
        <div>
      ...
      <div className="mb-4">
        ...
        <progress value={currentWeather.humidity} max="100" className="w-full h-2 bg-blue-200"></progress>
      </div>
